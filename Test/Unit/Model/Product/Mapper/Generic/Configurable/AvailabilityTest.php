...
{
    /**
     * @var \MageOS\ShoppingFeed\Model\Product\Mapper\Generic\Configurable\Availability
     */
    protected $model;
    ...
    protected function setUp(): void
    {
        ...
        $this->model = $this->objectManagerHelper->getObject(
            'MageOS\ShoppingFeed\Model\Product\Mapper\Generic\Configurable\Availability',
    ...
    {
        $this->expectReturn($this->feedMock, 'getConfig', true);
        $this->expectAdvencedReturn($this->statusMock, 'getStockStatus', $this->onConsecutiveCalls(1, 0));
        $this->expectReturn($this->parentAdapterMock, 'getFeed', $this->feedMock);
        $this->expectReturn($this->parentAdapterMock, 'getProduct', $this->productMock);
        $this->expectReturn($this->parentAdapterMock, 'getData', [$this->adapterMock]);
        $this->expectReturn($this->adapterMock, 'getProduct', $this->productMock);
