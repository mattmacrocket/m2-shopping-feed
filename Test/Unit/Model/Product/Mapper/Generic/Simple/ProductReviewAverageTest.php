...
/**
 * Class ProductReviewAverageTest
 *
 * @package MageOS\ShoppingFeed\Test\Unit\Model\Product\Mapper\Generic\Simple
 */
#[\PHPUnit\Framework\Attributes\AllowMockObjectsWithoutExpectations]
class ProductReviewAverageTest extends ModelFramework
{
    /**
     * @var \MageOS\ShoppingFeed\Model\Product\Mapper\Generic\Simple\ProductReviewAverage
     */
    protected $model;
    ...
    protected function setUp(): void
    {
        ...
        $this->summaryMock = $this->getModelMock(
            ...
            ['getRatingSummary', 'load']
        );
        $this->expectSelf($this->summaryMock, 'load');
        $this->expectReturn($this->summaryMock, 'getRatingSummary', 100);
        $this->expectReturn($this->adapterMock, 'getProduct', $this->productMock);

        $this->model = $this->objectManagerHelper->getObject(
            'MageOS\ShoppingFeed\Model\Product\Mapper\Generic\Simple\ProductReviewAverage',
            [
