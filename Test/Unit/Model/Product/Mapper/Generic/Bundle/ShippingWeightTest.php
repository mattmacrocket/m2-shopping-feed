...
namespace MageOS\ShoppingFeed\Test\Unit\Model\Product\Mapper\Generic\Bundle;
...
{
    /**
     * @var \MageOS\ShoppingFeed\Model\Product\Mapper\Generic\Bundle\ShippingWeight
     */
    protected $model;
    ...
    protected function setUp(): void
    {
        ...
        $this->model = $this->objectManagerHelper->getObject(
            'MageOS\ShoppingFeed\Model\Product\Mapper\Generic\Bundle\ShippingWeight',
            []
        );
    }

    public function testMapCominedWeight()
    {
        ...
        $this->expectReturn($this->adapterMock, 'getData', [$this->adapterMock]);
